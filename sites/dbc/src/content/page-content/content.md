...
jsonld:
  ...
  org_logo: https://dbcustomgarage.netlify.app/images/logo.svg
  org_description: Custom car builds, restoration, and performance tuning.
  webSiteName: DB Custom Garage
  webSiteUrl: https://dbcustomgarage.netlify.app
  phoneSpain: ""
  phoneItaly: ""
seo:
  title: DB Custom Garage
  description: Bespoke custom car builds, restorations, and performance tuning.
  theme_color: "#ea580c"
fleet:
  heading: Our Builds
stats:
  ...
  items:
    ...
    - label: 200+
      title: Cars Completed
    - label: 100%
      title: Custom, Never Off-the-Shelf
cta:
  heading: Ready to Build Something Unique?
  text: Drop us your ideas and we will quote your full custom build.
bottomcta:
  heading: Your Dream Car Starts Here
  values:
    - title: Book a Consultation
      text: Sit down with our builders and map out your project.
    - title: Get a Quote
      text: Transparent pricing on parts, labor, and finish.
branding:
