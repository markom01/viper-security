...
- [x] Contact form submits → appears in Netlify Forms dashboard
- [x] Decap CMS login → edit content → save → deploys
...
- [x] User can edit content via Decap CMS and see changes deploy
