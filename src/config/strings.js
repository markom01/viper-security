...
const STRINGS = {
  ...
  fleet: {
    ...
    seats: 'Seats',
    baggage: 'Baggage',
    capacityPassengers: 'Passengers',
    capacitySuitcases: 'Suitcases',
    capacityCarryon: 'Carry-on',
  ...
  pricing: {
    title: 'Pricing',
    hourlyHeading: 'Hourly Chauffeur Rates',
  ...
  bottomCta: {
    buttonServices: 'Our services',
    buttonFleet: 'Browse Fleet',
  },
